...
<head>
	...
	<title id="page-title">ANGSURAN COUPON PRINT | {{ config('app.name') }}</title>
    <style>
        body {
...
@foreach ($angsuranList->chunk(15) as $chunks)
                ...
                <div class="coupon-box">
                    <table width="100%">
                        <tr>
                            <td rowspan="2" style="width: 40%; padding-right: 5px;">
                                ...
                                <span style="font-size: 7px;">{{ $data->contract_code }}</span>
                            </td>
                            <td class="border" style="width: 33%; padding: 2px;">Angsuran Ke</td>
                            <td class="border" style="width: 28%; padding: 2px; text-align: right;"><b>{{ sprintf('%03d', $angsuran->number) }}</b> / {{ $data->tenor }}</td>
                        </tr>
                        <tr>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>Jenis Usaha</td>
                            <td>:</td>
                            <td>{{ $data->consumer->business_type }}</td>
                        </tr>
                    </table>
